""" 
BaseModel 繼承自 torch.nn.Module，主要負責：


建立詞彙、實體、關係的嵌入層（embedding layers）

提供 損失函數（KL、BCE）

提供 評估指標（Hit@1、F1）計算邏輯
...
class BaseModel(torch.nn.Module):
    ...
    def encode_rel_texts(self, rel_texts, rel_texts_inv):
        ...
        """
        print("[DEBUG][encode_rel_texts] rel_features:", self.rel_features.shape,
            "inv_features:", self.rel_features_inv.shape)
         """
